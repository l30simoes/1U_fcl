...
from .bot_direct import send_message, send_messages, send_media, send_medias, send_hashtag, send_profile, send_like, send_link
...
class Bot(API):
    ...
    # direct
    def send_link(self, text, user_ids, thread_id=None):
        return send_link(self, text, user_ids, thread_id)
